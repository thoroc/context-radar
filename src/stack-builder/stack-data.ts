...
export const LAYERS: StackLayer[] = [
  {id:"shell",name:"Shell & tool output compression",badge:"pick ONE shell tool",bc:"b-pick",
   ...
   tools:[
    {id:"rtk",name:"RTK",stars:"71k",desc:"Rust hook compressing git/test/lint output. 100+ patterns, v0.43.0. Most battle-tested option.",lic:"open",ll:"Apache-2",url:"https://github.com/rtk-ai/rtk",req:"Rust binary; no model calls",rec:true},
    {id:"sqz",name:"sqz",stars:"529",desc:"SHA-256 dedup cache. Repeat reads = 13 tokens. MCP server. v1.3.0.",lic:"warn",ll:"ELv2",url:"https://github.com/ojuschugh1/sqz",req:"Rust binary; no model calls"},
    {id:"lean-ctx",name:"lean-ctx",stars:"3.2k",desc:"Shell hook + 76 MCP tools. Property Graph, CCP memory, file guard. 30+ agents. Local-first.",lic:"open",ll:"Apache-2",url:"https://github.com/yvgude/lean-ctx",req:"Rust binary; no model calls; Bun optional"},
    {id:"omni",name:"omni",stars:"300",desc:"Rust Context OS. Rule-based TOML distillers. Engrams, context pressure traffic light, multi-agent. v0.6.2.",lic:"open",ll:"MIT",url:"https://github.com/fajarhide/omni",req:"Rust binary; no model calls; brew install fajarhide/tap/omni"},
    {id:"ace-ctx",name:"agent-context-economy",stars:"15",desc:"6 PowerShell scripts the agent calls instead of raw commands. run-compact.ps1 (-93% terminal lines), read-symbol.ps1 (named function only), read-window.ps1 (line range), investigate.ps1 (batched search). Stackable with RTK/omni - not either/or. Windows-first.",lic:"open",ll:"MIT",url:"https://github.com/grafikerdem/agent-context-economy",req:"PowerShell 7.0+; Windows-first (PowerShell Core on macOS/Linux); no model calls. git clone then setup-ai-scripts.ps1"},
    {id:"ctxlite",name:"ctxlite",stars:"5",desc:"Token optimizer for OpenCode+Cursor+Claude Code+Claude Desktop in one project. Pre-call rewrite, output compression, BM25 file selection, unified stats.db. Discloses exactly what's automatic vs on-demand per platform. MIT + Commons Clause (resale-restricted only).",lic:"open",ll:"MIT+Commons Clause",url:"https://github.com/ctxlite/ctxlite",req:"Zero-LLM; BM25 + tree-sitter only. Node.js for npx. npx @ctxlite/cli install --tool <platform>."},
  ]},
  {id:"output",name:"All tool output",badge:"install alongside shell tool",bc:"b-add",
   ...
   tools:[
    {id:"ctx-mode",name:"context-mode",stars:"19k",desc:"Sandboxes all tool output + session continuity across compaction. 17 platforms. v1.0.169.",lic:"warn",ll:"ELv2",url:"https://github.com/mksglu/context-mode",req:"Node.js 18+; no model calls",rec:true},
  ...
  {id:"push",name:"Static context injection",badge:"stackable",bc:"b-add",
   ...
   tools:[
    {id:"sigmap",name:"sigmap",stars:"598",desc:"Writes fn/class signatures to CLAUDE.md. 33 languages, 20 MCP tools. v8.18.0.",lic:"open",ll:"MIT",url:"https://github.com/manojmallick/sigmap",req:"Node.js 18+; no model calls",rec:true},
    ...
    {id:"codemap",name:"codemap",stars:"642",desc:"Go daemon: budget-aware context, cross-agent handoff, routing config. brew install. v4.1.10.",lic:"open",ll:"MIT",url:"https://github.com/JordanCoin/codemap",req:"Go binary; no model calls"},
    {id:"openwolf",name:"openwolf",stars:"2.1k",desc:"6 hooks: Do-Not-Repeat list, bug memory, file-map, token ledger. v2.0.1.",lic:"warn",ll:"AGPL-3.0",url:"https://github.com/cytostack/openwolf",req:"Node.js 20+; no model calls"},
    {id:"latmd",name:"lat.md",stars:"1.8k",desc:"Markdown knowledge graph for codebase (lat.md/ directory). Agents navigate via lat search/section/refs/expand instead of grep. lat check enforces wiki link + code ref integrity. lat mcp for MCP. By Yury Selivanov (asyncio, uvloop, EdgeDB). Dormant since Mar 2026.",lic:"open",ll:"MIT",url:"https://github.com/1st1/lat.md",req:"Node.js 22+, pnpm. lat search needs OpenAI or Vercel AI Gateway key; other commands work offline."},
  ]},
  {id:"conv",name:"Conversation history management",badge:"optional",bc:"b-watch",
   ...
   tools:[
    {id:"v-ctx",name:"virtual-context",stars:"58",desc:"OS virtual-memory model for message history. Very early, dormant.",lic:"open",ll:"Apache-2",url:"https://github.com/virtual-context/virtual-context",req:"Requires Ollama running locally; Python 3.10+",warn:true},
    {id:"magic-ctx",name:"magic-context",stars:"1.3k",desc:"Background historian, cache-aware compression, cross-session memory. v0.32.1. OpenCode only.",lic:"open",ll:"MIT",url:"https://github.com/cortexkit/magic-context",req:"OpenCode only (not Claude Code); Bun runtime",warn:true},
  ]},
  {id:"know",name:"Personal knowledge retrieval",badge:"stackable",bc:"b-add",
   ...
   tools:[
    {id:"qmd",name:"qmd",stars:"28k",desc:"BM25 + vector + LLM reranking over your notes/docs. Bun-native. MIT.",lic:"open",ll:"MIT",url:"https://github.com/tobi/qmd",req:"Node.js 18+ or Bun; no model calls",rec:true},
  ...
  {id:"lib",name:"Library documentation retrieval",badge:"stackable",bc:"b-add",
   ...
   tools:[
    ...
    {id:"jdocmunch",name:"jdocmunch-mcp",stars:"191",desc:"Indexes any doc repo or local folder on demand. ~62 tools, section-level retrieval. v1.98.0.",lic:"warn",ll:"Dual-use",url:"https://github.com/jgravelle/jdocmunch-mcp",req:"Python 3.10+; no model calls; uvx jdocmunch-mcp"},
    {id:"githits",name:"githits-cli",stars:"71",desc:"Version-aware index of the ENTIRE public OSS ecosystem (hosted). Search/read/grep any npm/PyPI/Crates/Go package's exact source at your installed version. get_example: cross-repo prior-art search. pkg_vulns/deps/changelog/upgrade-review. License filtering (strict/custom/yolo).",lic:"open",ll:"Apache-2.0",url:"https://github.com/githits-com/githits-cli",req:"SaaS-hosted - requires GitHits account + OAuth; indexing runs on their infra. Node.js 20.12+. npx githits@latest init. Forever-free tier.",warn:true},
  ]},
  {id:"tabular",name:"Tabular data retrieval",badge:"install if you use CSVs",bc:"b-watch",
   tools:[
    {id:"jdatamunch",name:"jdatamunch-mcp",stars:"73",desc:"Indexes CSV/Excel into SQLite. 25,333x reduction on 1M-row file. ~36 tools. v1.19.1.",lic:"warn",ll:"Dual-use",url:"https://github.com/jgravelle/jdatamunch-mcp",req:"Python 3.10+; no model calls; uvx jdatamunch-mcp"},
  ]},
  {id:"onboard",name:"Codebase understanding & onboarding",badge:"run periodically",bc:"b-watch",
   ...
   tools:[
    {id:"understand",name:"Understand Anything",stars:"74k",desc:"6-agent LLM pipeline → guided tours, domain view, committable graph. 14 platforms. v2.9.0.",lic:"open",ll:"MIT",url:"https://github.com/Lum1104/Understand-Anything",req:"Calls Anthropic API per /understand run; Node.js 18+/pnpm",warn:true},
  ]},
  {id:"codenav",name:"Code navigation",badge:"pick ONE primary",bc:"b-pick",
   ...
   tools:[
    {id:"codegraph",name:"codegraph",stars:"60k",desc:"Pre-indexed SQLite graph. 58% fewer tool calls, 22% faster (Opus 4.8 benchmark 2026-06-02). 8 agents. MIT.",lic:"open",ll:"MIT",url:"https://github.com/colbymchenry/codegraph",req:"Node.js 22+ or 24; no model calls; npm install",rec:true},
    {id:"tokensave",name:"tokensave",stars:"433",desc:"Rust rewrite of codegraph, self-disclosed. 80+ tools vs 9, 50+ languages vs 19+, 16 agent integrations vs 1, multi-branch indexing (unique), 26x faster indexing. Dead code, circular deps, type hierarchy, atomic edit primitives. Fully open MIT.",lic:"open",ll:"MIT",url:"https://github.com/aovestdipaperino/tokensave",req:"Zero-LLM. brew/scoop/cargo install tokensave. tokensave init then tokensave install --agent claude."},
    {id:"gitnexus",name:"GitNexus",stars:"44k",desc:"Zero-server code intelligence engine. LadybugDB, 16 MCP tools, --skills generates CLAUDE.md skill files. Enterprise tier. Cosign attestations.",lic:"warn",ll:"PolyForm NC",url:"https://github.com/abhigyanpatwari/GitNexus",req:"Node.js 18+; no model calls; npm install"},
    {id:"cbm-mcp",name:"codebase-memory-mcp",stars:"32k",desc:"Go graph, Cypher, 155 languages, SLSA Level 3. Semantic search + structural graph. MIT.",lic:"open",ll:"MIT",url:"https://github.com/DeusData/codebase-memory-mcp",req:"Go static binary; no model calls; npm/PyPI/Homebrew"},
    {id:"serena",name:"Serena",stars:"26k",desc:"LSP symbol retrieval + symbol-level editing (insert_after_symbol). MIT. Known 30GB memory leak.",lic:"open",ll:"MIT",url:"https://github.com/oraios/serena",req:"Python 3.10+; no model calls; uv install"},
    {id:"sourcebot",name:"sourcebot",stars:"3.6k",desc:"Self-hosted platform (Docker Compose). Zoekt code search, code nav, Ask Sourcebot NL Q&A. 469K Docker pulls. Ask Sourcebot + MCP now Enterprise-licensed (v5).",lic:"warn",ll:"FSL-1.1-ALv2 + ee",url:"https://github.com/sourcebot-dev/sourcebot",req:"Requires Docker Compose + PostgreSQL + Redis; Ask Sourcebot NL calls LLM",warn:true},
    {id:"graphify",name:"graphify",stars:"86k",desc:"Multimodal graph: code + PDFs + diagrams + video + SQL schemas. 50+ languages. v8.18.0.",lic:"open",ll:"MIT",url:"https://github.com/safishamsi/graphify",req:"Python 3.10+; no model calls"},
    {id:"graperoot",name:"GrapeRoot",stars:"930",desc:"Dual-graph (info graph + session memory). Run dgc instead of claude. Compounding context. 41% cheaper benchmark. Core graph engine is proprietary PyPI package.",lic:"paid",ll:"Apache-2 launcher + Proprietary core",url:"https://github.com/kunal12203/codex-cli-compact",req:"Core graperoot engine is proprietary (no source). Python 3.10+, Node.js 18+. curl install."},
    ...
    {id:"cgc",name:"CodeGraphContext",stars:"3.9k",desc:"Python MCP, KùzuDB, pre-indexed bundles. 78 contributors. v0.4.7.",lic:"open",ll:"MIT",url:"https://github.com/CodeGraphContext/CodeGraphContext",req:"Python 3.10+; no model calls"},
    {id:"sdl-mcp",name:"sdl-mcp",stars:"440",desc:"Iris Gate Ladder: 4-rung escalation (100-token card → raw source). SCIP, live indexing. FD leak.",lic:"warn",ll:"Source-avail",url:"https://github.com/GlitterKill/sdl-mcp",req:"Node.js 24+ required (not 18/20/22)"},
    {id:"jcodemunch",name:"jCodemunch",stars:"2k",desc:"AST + BM25 + semantic. find_importers, get_blast_radius, get_ranked_context. 419K MCP installs. Free non-commercial.",lic:"warn",ll:"Dual-use",url:"https://github.com/jgravelle/jcodemunch-mcp",req:"Python 3.10+; optional OpenAI key for semantic mode; uvx jcodemunch-mcp"},
    {id:"pharos",name:"pharos-mcp",stars:"4",desc:"LSP-MCP bridge: 53 tools via rust-analyzer/gopls/tsserver/pyright + 18 more. +7-29pp accuracy. v0.1.4.",lic:"warn",ll:"AGPL-3.0+commercial",url:"https://github.com/LoganBresnahan/pharos-mcp",req:"Language servers must be installed separately; npm install -g pharos-mcp for pre-built binary"},
    ...
    {id:"socraticode",name:"SocratiCode",stars:"3.1k",desc:"Semantic search + OpenAPI/Prisma/Terraform structured artifacts. Docker Qdrant.",lic:"warn",ll:"AGPL-3.0",url:"https://github.com/giancarloerra/SocratiCode",req:"Requires Docker (Qdrant container); Node.js 18+",warn:true},
  ...
  {id:"defs",name:"MCP definition tokens",badge:"install both",bc:"b-add",
   ...
   tools:[
    ...
    {id:"mcpick",name:"mcpick",stars:"91",desc:"Manual CLI toggle of MCP servers per session.",lic:"open",ll:"MIT",url:"https://github.com/spences10/mcpick",req:"Node.js 18+; no model calls"},
  ]},
  {id:"gov",name:"Cross-session governance",badge:"optional",bc:"b-watch",
   tools:[
    {id:"graphiti",name:"graphiti",stars:"29k",desc:"Temporal context graph. Every fact has a validity window - query what was true on any date. mcp_server/ included.",lic:"open",ll:"Apache-2.0",url:"https://github.com/getzep/graphiti",req:"Requires graph DB (FalkorDB: docker run falkordb/falkordb:latest) + LLM API key; pip install graphiti-core",warn:true},
    {id:"bitloops",name:"Bitloops",stars:"230",desc:"Team-shared reasoning linked to git commits. DevQL, Jira/Confluence ingestion. v0.0.31.",lic:"open",ll:"Apache-2",url:"https://github.com/bitloops/bitloops",req:"Rust binary; optional OpenAI key for embeddings"},
    {id:"aura",name:"Aura",stars:"36",desc:"AST Merkle-Graph, fn-level rewind, compressed handover across sessions.",lic:"open",ll:"Apache-2",url:"https://github.com/Naridon-Inc/aura",req:"Rust binary; no model calls"},
    {id:"aictx",name:"aictx",stars:"54",desc:"Repo-local continuity runtime. aictx resume produces a capsule (active task, next action, known failures, strategy hints). aictx finalize records what happened. Failure Memory tracks structured failure patterns - agents avoid repeating them. 49 releases, v7.0.1. No model calls.",lic:"open",ll:"MIT",url:"https://github.com/oldskultxo/aictx",req:"Python 3.10+; no model calls; no external API; pip install aictx then aictx install then aictx init"},
    {id:"greplica",name:"greplica",stars:"313",desc:"Graph memory of engineering knowledge (components, flows, decisions). greplica-bootstrap once, greplica-update-working-memory each session, greplica graph context \"<question>\" retrieves prior context. Benchmarked on SWE-chat: 40-50% token reduction, up to 75% best case. No licence file.",lic:"paid",ll:"No licence file",url:"https://github.com/Autoloops/greplica",req:"Node.js + npm (better-sqlite3 needs build tools). Local embedding mode = no API key. OpenAI mode needs OPENAI_API_KEY."},
  ]},
  {id:"resp",name:"Response & memory compression",badge:"install",bc:"b-add",
   ...
   tools:[
    {id:"caveman",name:"caveman",stars:"89k",desc:"Cuts 65% of output tokens by talking like caveman. Compresses CLAUDE.md ~45%. v1.9.1.",lic:"open",ll:"MIT",url:"https://github.com/JuliusBrussee/caveman",req:"Skill file; no runtime; no model calls; npx skills add JuliusBrussee/caveman",rec:true},
  ]},
  ...
  {id:"audit",name:"Config stack audit",badge:"run once after setup",bc:"b-add",
   ...
   tools:[
    {id:"tokenopt",name:"token-optimizer",stars:"1.6k",desc:"6 audit agents across CLAUDE.md, skills, MCP servers. Skill usage analytics. Dashboard. v5.11.50.",lic:"warn",ll:"PolyForm NC",url:"https://github.com/alexgreensh/token-optimizer",req:"Python 3.10+ + Claude Code skill; dispatches 6 Claude Code sub-agents (uses your Claude session)",rec:true,warn:true},
    {id:"ctxharness",name:"ctxharness",stars:"18",desc:"Validates CLAUDE.md for drift: L1 version facts, L2 instruction quality, L3 hook/skill/rule assembly. Auto-fix. Score + CI diff. By RTK author.",lic:"open",ll:"MIT",url:"https://github.com/FlorianBruniaux/ctxharness",req:"Node.js 18+; no model calls; npx ctxharness"},
  ...
  {id:"agentmem",name:"Agent memory persistence",badge:"pick one",bc:"b-add",
   ...
   tools:[
    {id:"claudemem",name:"claude-mem",stars:"87k",desc:"Claude Code-native. 5 hooks capture observations, compress via Claude SDK, store SQLite+Chroma. 3-layer search→timeline→get_observations (~10x savings). Web viewer. v13.11.0.",lic:"open",ll:"Apache-2.0",url:"https://github.com/thedotmack/claude-mem",req:"Compression uses Claude agent SDK (calls Claude API). Auto-installs Bun + uv. npx claude-mem install (not npm install -g).",rec:true,warn:true},
    {id:"claudesmart",name:"claude-smart",stars:"745",desc:"Self-improvement: learning not memory. Corrections → actionable rules Claude follows. Self-tuning skill library (merge, archive, supersede). Project-specific + shared skills. ONNX in-process embeddings - no LLM API needed. Dashboard. ~2.7x quality vs claude-mem (EXPERIMENT.md). Powered by Reflexio.",lic:"open",ll:"Apache-2.0",url:"https://github.com/ReflexioAI/claude-smart",req:"Python 3.12+, Node.js 20+, uv. ONNX model ~86MB downloaded once. npx claude-smart install."},
    ...
    {id:"gitmem",name:"gitmem",stars:"33",desc:"Git-native shared memory. Multi-tool shared brain (Claude Code + Codex + Copilot + Gemini share one memory). PR governance. Claude Code capture not yet shipped.",lic:"open",ll:"MIT",url:"https://github.com/dev-boz/gitmem",req:"LLM API key for dream pipeline. pip install from git. Claude Code capture in Next roadmap."},
    {id:"memoir",name:"memoir",stars:"593",desc:"Git-like versioning for AI memory. Branch-aware (git checkout → branch-appropriate memories). Cache-preserving injection. memoir blame/checkout. Native Claude Code plugin. v0.2.4.",lic:"open",ll:"Apache-2.0",url:"https://github.com/zhangfengcdt/memoir",req:"Defaults to claude-haiku-4-5 (requires ANTHROPIC_API_KEY) or set MEMOIR_LLM_MODEL for OpenAI. /plugin marketplace add zhangfengcdt/memoir.",warn:true},
  ...
  {id:"safety",name:"Agent safety enforcement",badge:"separate concern",bc:"b-watch",
   ...
   tools:[
    {id:"sponsio",name:"Sponsio",stars:"465",desc:"Runtime contract enforcement. Plain-English rules → DFA checked in <0.01ms. OWASP Agentic Top 10. v0.1.1 alpha.",lic:"open",ll:"Apache-2",url:"https://github.com/SponsioLabs/Sponsio",req:"Python 3.9+ or Node.js 18+; no model calls"},
